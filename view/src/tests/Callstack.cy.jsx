...
specify('a call stack with macro-function difference should be visualised correctly', () => {
  ...
  cy.mount(<Callstack
    compFunName={MacroFunctionDifference.function}
    oldCallStack={MacroFunctionDifference.diffs[0]['old-callstack']}
    newCallStack={MacroFunctionDifference.diffs[0]['new-callstack']}
    definitions={{}}
    onSelect={() => {}}
  />);
  checkCallStackAppearance(expectedVisualisation);
